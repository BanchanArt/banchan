...
let MarkdownInput = {
  ...
  initEditor() {
    ...
    // NB(@zkat): This component doesn't support being server-updated. While
    // unfortunate, this is to prevent certain race conditions/update loops
    // from happening that are actually very hard to work around. If you run
    // into this comment and you want to give it a shot, feel free, but note
    // that you're gonna want to test with latency turned up to make sure your
