  ...
  addListeners() {
    ...
    this.imageEvents = this.images.map((image, idx) => {
      return [
        ...
        image.addEventListener("dragend", () => {
          ...
          this.pushEventTo(this.el, "items_reordered", {
    ...
    this.dragover = this.el.addEventListener("dragover", e => {
      ...
      if (over == dragged) {
        ...
        this.el.querySelector(".item-container").insertBefore(dragged, over.nextSibling);
        this.updateImages();
      } else if (over) {
        this.el.querySelector(".item-container").insertBefore(dragged, over);
        this.updateImages();
      }
    });
  },
