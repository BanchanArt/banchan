  ...
  def render(assigns) do
    ...
    <div class="timeline">
      <article class="timeline-item">
        <Card>
          <:header>
            <img class="w-6 inline-block" src={Routes.static_path(Endpoint, "/images/kat-chibi.jpeg")}> {@current_user.handle} commented 3 days ago.
          </:header>
          <div class="content">
            Hello I would like a really nice commission of my cool OC. I've attached some screenshots.
          </div>
          <:footer>
            <img class="inline w-16" src={Routes.static_path(Endpoint, "/images/penana-left.png")}> <img class="inline w-16" src={Routes.static_path(Endpoint, "/images/penana-right.png")}> <img class="inline w-16" src={Routes.static_path(Endpoint, "/images/penana-front.png")}>
          </:footer>
        </Card>
      </article>
      ...
      <article class="timeline-item block">
        <Card>
          ...
          <div class="content">
            <p>Hi, I'm happy to work on this! It sounds really cute.</p> <p>I can get started as soon as I receive the initial payment!</p>
          </div>
        </Card>
      </article>
