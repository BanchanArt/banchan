  ...
  def render(assigns) do
    ...
    <div class="flex flex-col gap-2 w-full">
      <div class="flex flex-row gap-2 items-center">
        ...
        <Dropdown label={Commissions.Common.humanize_status(@commission.status)}>
          <DropdownItem label="Accepted" click="update_status" value="accepted" description="Accept the commission." />
          <DropdownItem label="Rejected" click="update_status" value="rejected" description="Reject the commission." />
          <DropdownItem label="Paused" click="update_status" value="paused" description="Pause active work on the commission." />
          <DropdownItem label="In Progress" click="update_status" value="in_progress" description="Work on this commission is actively happening." />
          <DropdownItem label="Waiting" click="update_status" value="waiting" description="The studio is waiting for something from the client before continuing work." />
        </Dropdown>
      </div>
    </div>
    """
