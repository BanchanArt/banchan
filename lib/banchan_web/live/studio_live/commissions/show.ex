defmodule BanchanWeb.StudioLive.Commissions.Show do
  ...
  def handle_info(%{event: "new_events", payload: events}, socket) do
    # TODO: I don't know why, but we sometimes get two `new_events` messages for a single event addition. So we have to dedup here just in case until that bug is... fixed? If it's even a bug vs something expected?
