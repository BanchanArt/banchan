        ...
        <div class="w-full max-w-lg p-10 mx-auto rounded-xl md:my-10 bg-base-200">
          ...
          {#else}
            <Form class="flex flex-col gap-4" for={%{}} as={:bug_report} submit="submit">
              ...
              <p>To submit a bug report for Banchan Art, you may use this form or <a href="https://github.com/BanchanArt/banchan/issues/new/choose" class="link">Github</a>. Please include as much context as you can.</p>
              <p>You may view existing bugs using our <a href="https://github.com/BanchanArt/banchan/issues" class="link">Github issues page.</a></p>
