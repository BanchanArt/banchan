defmodule BanchanWeb.DiscoverLive.Components.Offerings do
  ...
  def render(assigns) do
    ...
    ~F"""
    <discover-offerings class="flex flex-col items-center w-full">
      ...
      {#else}
        <div class="grid grid-cols-1 offering-list gap-2 sm:gap-2 sm:grid-cols-2 lg:grid-cols-3 auto-rows-fr">
