    ...
    <Layout flashes={@flash}>
      <#Markdown class="w-full px-4 py-2 mx-auto prose max-w-7xl">
        ...
        **Company** (referred to as either "the Company", "We", "Us" or "Our" in
        this Agreement) refers to Digital Workers Guild LLC, 440 N Barranca Ave
        #8687 Covina, CA 91723.
        ...
        **Do Not Track** (DNT) is a concept that has been promoted by U.S.
        ...
        **You** means the individual accessing or using the Service, or the
        ...
        -   **With Affiliates:** We may share Your information with Our
            ...
            other subsidiaries, joint venture partners or other companies, if
        ...
        We may use third-party Service Providers to help Us resolve
        customer-service tickets.

        #### *Freshdesk*

        Freshdesk is a cloud-based customer service software company that
        provides tools for customer relationship management and IT service
        management.

        For more information on the privacy practices of Freshdesk, please visit
        the Freshworks Privacy web page: <https://www.freshworks.com/privacy/>
        ...
        provided in any email We send or by contacting Us. Please note that
        while You may opt out of marketing communications, transactional emails
        essential to your account or Service functionality will not contain
        unsubscribe links.
        ...
        We may use or disclose and may have used or disclosed in the last 12
        ...
        -   **The right to say no to the sale of Personal Data (opt-out).** You
            ...
            To submit an opt-out request please contact Us. Please note,
            however, that We do not currently sell any personal information.
        ...
        Please note, however, that We do not sell any personal information in
        any case. If we were ever to start selling personal information, You
        could choose to opt out. If We were to receive and confirm a verifiable
        consumer request from You, we would stop selling Your personal
