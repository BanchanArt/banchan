defmodule BanchanWeb.Endpoint do
  ...
  plug Plug.Static,
    ...
    from: :banchan,
    gzip: false,
    only: ~w(assets fonts images js robots.txt android-chrome-96x96.png apple-touch-icon.png browserconfig.xml favicon-16x16.png favicon-32x32.png mstile-150x150.png site.webmanifest)
